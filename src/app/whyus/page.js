export default function WhyUs () {
    return(
        <>
        <div className='flex justify-center items-center w-screen text-4xl font-serif bg-base-200'>KENAPA MEMILIH KITA?</div>
        <div className='bg-white grid sm:grid-cols-1 md:grid-cols-2 justify-center items-center w-screen h-screen'>
            ...
            <div className="card w-96 bg-white text-black pb-14 ">
                <div className="card-body">
